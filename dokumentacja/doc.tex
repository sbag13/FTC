...
Specyfikacja nie określa w żaden sposób formy w jakiej ma być zwracana lista ofert. Jedyna klarowna informacja na ten temat to założenie, że jeśli użyte zostaną filtry i żadna z ofert nie będzie spełniała wymagań, to zwrócona zostanie pusta lista "\lbrack\rbrack". \\
...
\begin{itemize}
    ...
    \item "created\_by\_me" - jeśli ustawiony, powinien zwracać tylko oferty których zalogowany użytkownik jest właścicielem
\end{itemize}
...
\newline\url{https://django-q.readthedocs.io/en/latest/}.
