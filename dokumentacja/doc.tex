...
W implementacji 2. w przypadku wykorzystania generycznych widoków w postaci klas problem jest rozwiązany automatycznie. Wykorzystanie nie zdefiniowanej metody dla zarejestrowanego adresu url zawsze skutkuje zwróceniem statusu 405, chyba, że zachowanie to zastanie świadomie nadpisane. \\
